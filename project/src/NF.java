...
public class NF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                                Your to do-List");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       detete_taskS d = new detete_taskS();
       d.delete();
    }//GEN-LAST:event_jButton2ActionPerformed
 public static void AddRows(Object[] dataRow){
        DefaultTableModel m = (DefaultTableModel)jTable1.getModel();
        m.addRow(dataRow);
    }

       
    public class detete_taskS{
        public void delete(){
            DefaultTableModel x = (DefaultTableModel)jTable1.getModel();
        if(jTable1.getSelectedRowCount()==1){
           x.removeRow(jTable1.getSelectedRow());
           
       }
       else{
            NF n = new NF();
           if(jTable1.getRowCount()==0)
               JOptionPane.showConfirmDialog(n, "Table is Empty !!");
           else{
               JOptionPane.showConfirmDialog(n, "Please select any single Row For Delete  !!");
           }
       }
        }
